...
define config.name = ("Pronoun Tool")
...
# 1.01 Updated text tag names to avoid any potential conflict with default Ren'Py
# 1.0 Release
...
define config.exit_replay_transition = fade
...
define config.save_directory = "pronountool-1606448475"
